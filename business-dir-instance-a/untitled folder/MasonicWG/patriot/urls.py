...
urlpatterns = [
    ...
    path('oidc/', include('mozilla_django_oidc.urls')),  # gives oidc_authentication_init + callback + logout
    ...
    # other template-based pages
    path("privacy-policy/",TemplateView.as_view(template_name="other/privacy_policy.html"),name="privacy",),
    path("about/", TemplateView.as_view(template_name="other/about.html"), name="about"),
    path("contact/", TemplateView.as_view(template_name="other/contact.html"), name="contact"),
    path("faq/", TemplateView.as_view(template_name="other/faq.html"), name="faq"),
    path("corporate-ethics/", TemplateView.as_view(template_name="other/corporate_ethics.html"), name="ethics"),
    path("explore/", TemplateView.as_view(template_name="other/explore.html"), name="explore"),
]
