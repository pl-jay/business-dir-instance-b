...
from django.core.paginator import Paginator          # ← needed
from django.http import JsonResponse                 # if not already there
from django.template.loader import render_to_string  # if not already there
...
def build_business_qs(request) -> QuerySet:
    ...
    """
    qs: QuerySet = Business.objects.all()
